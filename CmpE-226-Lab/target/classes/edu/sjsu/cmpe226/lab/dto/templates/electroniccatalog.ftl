...
<tr>
<td align="center">
	<img src=${product.URL} width="500" height="750">
</td>
<td aligh="center">
	...
	<b>Ratings : </b>${product.ratings} <br />
	<b>Width : </b>${product.width} <br />
	<b>Dimensions : </b>${product.dimensions} <br />
	<b>Resolution : </b>${product.resolution} <br />
	<b>Refresh Rate : </b>${product.refresh_rate} <br />
</td>
</table>

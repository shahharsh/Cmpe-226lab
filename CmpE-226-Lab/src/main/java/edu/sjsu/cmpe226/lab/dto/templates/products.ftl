...
.affix {
	...
	<body>
	<img src="http://insights.sererra.com/Portals/107657/images/Eparts-Trolley-shutterstock_9263164.jpg" class="span2"> <a href="#"></a> </img>
		
			
			
				<div class="navbar-inner">
				<td> </td> <tr> </tr>
				<h1 style="color:red; text-align:center"> <a href="/CmpE-226-Lab/rest/catalog/productscatalog"> Product Catalog </a> </h1>
		...
		<div>
		 <div  align="right">
        <input  type="text" id="sbar" class="span2 search-query">
        <button type="submit" onclick="search()" class="btn">Search</button>
        </div>
        ...
        <script type="text/javascript">
	        ...
	        var a = document.getElementById("sbar").value;
			alert(a);
			window.open("http://localhost:8080/CmpE-226-Lab/rest/catalog/search/"+a,"_self");
			...
			<ul class="nav nav-list span3">
				...
				<li> <a href="/CmpE-226-Lab/rest/catalog/electronicscatalog"> Electronics </a></li>
				<li> <a href="/CmpE-226-Lab/rest/catalog/homeappliancescatalog"> Home Appliances </a> </li>
				<li> <a href="/CmpE-226-Lab/rest/catalog/cosmeticscatalog"> Cosmetics </a> </li>
				<li> <a href="/CmpE-226-Lab/rest/catalog/bookscatalog"> Books </a> </li>
	...
	<tr>
		<#list items as item>
			<td width="400" align="center">
				<a href="/CmpE-226-Lab/rest/catalog/productcatalog/${item.product_id}"> <img src=${item.URL} height="100" width="100"> </a> <br /> 
				<a href="/CmpE-226-Lab/rest/catalog/productcatalog/${item.product_id}"> ${item.name} </a> <br /> 
